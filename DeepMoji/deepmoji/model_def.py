...
from tensorflow.keras.layers import Input, Bidirectional, Embedding, Dense, Dropout, SpatialDropout1D, Activation, LSTM
...
def deepmoji_architecture(nb_classes, nb_tokens, maxlen =50, feature_output=False, embed_dropout_rate=0, final_dropout_rate=0, embed_l2=1E-6, return_attention=False):
    """
